...
rpc = Presence("833767226304888903")
rpc.connect()
rpc.update(state="Generating Nitro",details="nitro.py",large_image="nitro_v1",start=time.time())


os.system("cls")

print(f"{Fore.WHITE}[ {Fore.CYAN}\u00A7 {Fore.WHITE}] {Fore.LIGHTBLACK_EX}[CR]Discord Nitro Generator made by {Fore.WHITE}LnX, edited by Lunaaaaa{Fore.LIGHTBLACK_EX} | Lunaaaaa {Fore.WHITE}DC {Fore.LIGHTBLACK_EX}No License")
print(f"{Fore.WHITE}[ {Fore.CYAN}\u00A7 {Fore.WHITE}] {Fore.LIGHTBLACK_EX}[CR]Follow him on Github: {Fore.WHITE}https://github.com/lnxcz")
